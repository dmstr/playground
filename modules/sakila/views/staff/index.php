...
* @var app\modules\sakila\models\search\Staff $searchModel
*/
...
<div class="staff-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('app', 'New') . ' Staff', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
