...
* @var app\modules\sakila\models\search\Actor $searchModel
*/
...
<div class="actor-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('app', 'New') . ' Actor', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
