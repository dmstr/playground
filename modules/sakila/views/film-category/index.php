...
* @var app\modules\sakila\models\search\FilmCategory $searchModel
*/
...
<div class="film-category-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('app', 'New') . ' Film Category', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
