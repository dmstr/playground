...
* @var app\modules\sakila\models\search\Payment $searchModel
*/
...
<div class="payment-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('app', 'New') . ' Payment', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
