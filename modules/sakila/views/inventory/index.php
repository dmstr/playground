...
* @var app\modules\sakila\models\search\Inventory $searchModel
*/
...
<div class="inventory-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('app', 'New') . ' Inventory', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
